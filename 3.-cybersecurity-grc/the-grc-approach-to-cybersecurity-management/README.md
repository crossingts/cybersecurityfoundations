...
* **Risk Management Strategy (GV.RM):** Establishing, agreeing to, and communicating the organization's cybersecurity risk appetite, tolerance, and priorities. For example, leadership defining acceptable levels of financial or reputational risk from a data breach.
