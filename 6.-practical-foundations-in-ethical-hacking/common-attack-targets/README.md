...
| **Injection Flaws** (SQLi, XSS)           | 9.8 (Critical) | High               | Critical   | Web apps, APIs, Databases                  | SQLi, XSS, Command Injection                               | Equifax (SQLi)                                           | <p>▶ Parameterized queries.<br>▶ Input sanitization.<br>▶ WAF rules (e.g., ModSecurity).</p>                                     |
