...
Note - /etc/passwd stores user account information (username, UID, GID, home directory, default shell). However, the password field holds a placeholder (usually x) that signals "go look in /etc/shadow."
