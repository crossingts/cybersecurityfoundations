...
Below is an update of Table 4-3 (Walker, 2012, p. 98) Nmap switches, with notes where syntax or functionality has changed.
...
| `-T5`                        | Parallel, fastest scan      | `-T5`          | Unchanged – `-T5` (Insane)                                                               |
